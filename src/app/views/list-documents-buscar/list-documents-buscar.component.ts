...
@Component({
  selector: 'app-list-documents-buscar',
  templateUrl: './list-documents-buscar.component.html',
  styleUrls: ['./list-documents-buscar.component.scss'],
  providers: [DialogService, ConfirmationService]
})
export class ListDocumentsBuscarComponent implements OnInit {
