...
public guardarConcepto() { 
 ...
 if( this.concepto.descripcion==null || this.concepto.descripcion=="" ){
  ...
  if(this.concepto.maximo < this.concepto.minimo && (this.concepto.tipoConceptoId == 2 || this.concepto.tipoConceptoId == 3 ||this.concepto.tipoConceptoId == 5) ){
    this.msgs.push({severity:'error', detail: "El maximo no puede ser menor que el minimo"  , summary:'Validation failed'});
    return ;
  }
  ...
  if(this.concepto.maximo <= 0 && this.selectedTipoConcepto.tipoConceptoId == 2){
    this.msgs.push({severity:'error', detail: "El maximo no puede ser menor ni igual que cero"  , summary:'Validation failed'});
    return ;
  }
  ...
  if( this.selectedTipoConcepto.tipoConceptoId==13)
  {
    ...
    this.concepto.alertaRojo=0;
      ...
      sPerfilRojo = this.getPerfilesConcat(this.conceptoAlertaPerfilRojoSeleccion);
      sPerfilAmarillo = this.getPerfilesConcat(this.conceptoAlertaPerfilAmarilloSeleccion);
...
public tipoConceptoChanged(){ /*Validar que sucedera al momento de editar y cambiar el concepto*/
console.log("tipoConceptoSeleccionado: " + this.selectedTipoConcepto.tipoConceptoId);
  this.concepto=new Concepto();
  this.concepto.tipoConceptoId =  this.selectedTipoConcepto.tipoConceptoId;
  if(  this.selectedTipoConcepto.tipoConceptoId==6 ||  this.selectedTipoConcepto.tipoConceptoId==7 ){
    this.selectedTipoLista=this.tiposLista[0];   
...
public initFlagsConceptoAlerta(conceptoAlerta : ConceptoAlertaPerfil[] , conceptoAlertaSeleccion : ConceptoAlertaPerfil[] ): ConceptoAlertaPerfil[] {
