...
public getPerfilesByUsuarioOID(usuarioOID:string,usuarioConsultaOID:string   ) : Observable<PerfilUsuario[]> {
  let url:string = GlobalConstants.apiURL + "usuarios/getPerfilesByUsuarioOID/" + usuarioOID + "/" + usuarioConsultaOID ;
