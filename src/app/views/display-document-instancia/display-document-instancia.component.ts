...
clearFile(event, valorConcepto){
 ...
 public configRespuestasForView()  {
  ...
  {if(this.documentoInstancia.imagePath != null) this.documentoInstancia.imagePath = this.usuario.infoHuesped.pathImagenWeb + this.documentoInstancia.imagePath
    else this.documentoInstancia.imagePath =  "assets/img/NoImagen.png";
          ...
          if( ci.opcionesInstancia!=null && ci.opcionesInstancia.length>0  ){
              for( var i=0; i<ci.opcionesInstancia.length; i++  ){
                   ...
                   if( oi.seleccionado ==1 ){
                      selectedValues.push( oi.opcionOID );
                   }
              }
          } 
...
console.log(mydate.toDateString());
  ...
  public guardarSeccion(nextSeccionOID: string){
    ...
    if( nextSeccionOID==null)  this.blockedDocument = true;
    this.documentoInstanciaService.guardarDocumentoInstanciaRespuestas ( this.documentoInstancia, this.usuarioOID ).subscribe((data)=>{
